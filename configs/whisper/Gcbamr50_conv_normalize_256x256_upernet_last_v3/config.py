...
launcher = 'none'
load_from = '/home/hjkim/seg-challenge/mmsegmentation/workdir/whisper/Gcbamr50_conv_normalize_256x256_upernet_last_v3/iter_30000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='outputs/last_v3_base_30/',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadMultipleRSImageFromFile'),
    dict(keep_ratio=True, scale=(

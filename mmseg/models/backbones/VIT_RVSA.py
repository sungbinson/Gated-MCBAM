...
class ViT_Win_RVSA_V3_WSZ7(nn.Module):
    ...
    """
    def __init__(self, img_size=128, patch_size=8, in_chans=3, num_classes=9, embed_dim=768, depth=12,
            ...
            if self.in_chans != 3:
                for k in list(state_dict.keys()):
                    if 'patch_embed.proj' in k:
                        del state_dict[k]
            keys_to_remove = [k for k in state_dict.keys() if 'patch_embed' in k]
